...
<div class="login-box">
  <div class="login-logo" style="font-size: large !important;">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ admin_base_path('auth/login') }}" method="post">
      ...
      <div class="form-group has-feedback {!! !$errors->has('company_code') ?: 'has-error' !!}">
        ...
        <input type="input" class="form-control" placeholder="{{ trans('admin.company_code') }}" name="company_code" value="{{ old('company_code') }}">
